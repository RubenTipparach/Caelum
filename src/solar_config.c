...
SolarSystemConfig solar_system_default_config(void) {
    ...
    cfg.moons[3] = (MoonConfig){
        ...
        .noise_seed = 400, .noise_frequency = 0.6f, .noise_amplitude = 0.01f, .noise_octaves = 3,
    ...
    cfg.moons[5] = (MoonConfig){
        ...
        .noise_seed = 600, .noise_frequency = 0.5f, .noise_amplitude = 0.01f, .noise_octaves = 2,
    ...
    cfg.moons[6] = (MoonConfig){
        ...
        .noise_seed = 700, .noise_frequency = 0.6f, .noise_amplitude = 0.01f, .noise_octaves = 2,
    ...
    cfg.moons[7] = (MoonConfig){
        ...
        .noise_seed = 800, .noise_frequency = 0.5f, .noise_amplitude = 0.01f, .noise_octaves = 3,
    ...
    cfg.moons[8] = (MoonConfig){
        ...
        .noise_seed = 900, .noise_frequency = 0.7f, .noise_amplitude = 0.01f, .noise_octaves = 2,
    ...
    cfg.moons[9] = (MoonConfig){
        ...
        .noise_seed = 1000, .noise_frequency = 0.7f, .noise_amplitude = 0.01f, .noise_octaves = 2,
